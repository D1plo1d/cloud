...
Vagrant::Config.run do |config|
  ...
  config.vm.provision :shell, :inline => "cd /vagrant; su vagrant ./script/vagrant_up.sh"
  ...
  config.vm.forward_port 9001, 8880

  # Faye Private Pub/Sub Server
  ...
  # Fixing bad permissions in vagrant vm
