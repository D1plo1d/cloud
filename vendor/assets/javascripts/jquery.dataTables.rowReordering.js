...
(function ($) {
    ...
    $.fn.rowReordering = function (options) {
        ...
        function fnGetState(sSelector, tr) {

            //var iCurrentPosition = parseInt( oTable.fnGetData(tr[0], properties.iIndexColumn) );
            var iCurrentPosition = parseInt( tr.find("td:first").html() );
            ...
            if (trPrevious.length > 0) {
                ...
                iNewPosition = parseInt( trPrevious.find("td:first").html() );
                ...
                if (trNext.length > 0) {
                    iNewPosition = parseInt( trNext.find("td:first").html() );
        ...
        function fnMoveRows(sSelector, iCurrentPosition, iNewPosition, sDirection, $tr, sGroup) {
        ...
        return this.each(function () {
            ...
            $("tbody", oTable).disableSelection().sortable({
                ...
                update: function (event, ui) {
                  ...
                  var oState = fnGetState(sSelector, $context);
                  ...
                  if (properties.sURL != null) {
                    ...
                    $.ajax({
                      url: ( $.isFunction(properties.sURL)? properties.sURL(ajaxData, $context ) : properties.sURL ),
                      type: properties.sRequestType,
                      data: ( (properties.sData != null)? properties.sData(ajaxData, $context) : ajaxData),
                      success: function () {
                        fnMoveRows(sSelector, oState.iCurrentPosition, oState.iNewPosition, oState.sDirection, $(ui.item.context), sGroup);
                        properties.fnEndProcessingMode();
                      },
